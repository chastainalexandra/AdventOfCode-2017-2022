...
#  if you can boost its signal strength high enough; there's a little meter that indicates the antenna's signal strength by displaying 0-50 stars.
...
part01(input) #Answer 1557 
part02(input) #Answer 1608
